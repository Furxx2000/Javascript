...
class Workout {
  date = new Date();
  id = (Date.now() + '').slice(-10); //transform to string
  clicks = 0;
...
class App {
  ...
  _loadMap(position) {
    ...
    // console.log(
    //   `https://www.google.com.tw/maps/@${latitude},${longitude},16z?hl=zh-TW`
    // );
  ...
  _renderWorkoutMarker(workout) {
    L.marker(workout.coords)
      ...
      .setPopupContent(
        `${this.#workouts.indexOf(workout) + 1} ${
  ...
  _renderWorkout(workout) {
    ...
    <li class="workout workout--${workout.type}" data-id="${workout.id}">
          <h2 class="workout__title">${this.#workouts.indexOf(workout) + 1}. ${
      workout.description
    }</h2>
          <p class="workout__edit">Edit</p>
          <span class="workout__cancel">⨉</span>
